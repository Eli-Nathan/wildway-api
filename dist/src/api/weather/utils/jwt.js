...
exports.isWeatherKitConfigured = exports.generateWeatherKitJWT = void 0;
...
const PRIVATE_KEY = (_a = process.env.WEATHERKIT_PRIVATE_KEY) === null || _a === void 0 ? void 0 : _a.replace(/\\n/g, "\n");
...
function generateWeatherKitJWT() {
    ...
    if (!TEAM_ID || !KEY_ID || !PRIVATE_KEY) {
        throw new Error("WeatherKit credentials not configured. Set WEATHERKIT_TEAM_ID, WEATHERKIT_KEY_ID, and WEATHERKIT_PRIVATE_KEY");
    }
    const header = {
        alg: "ES256",
        kid: KEY_ID,
...
exports.generateWeatherKitJWT = generateWeatherKitJWT;
/**
 * Check if WeatherKit credentials are configured
 */
function isWeatherKitConfigured() {
    return Boolean(TEAM_ID && KEY_ID && PRIVATE_KEY);
}
exports.isWeatherKitConfigured = isWeatherKitConfigured;
