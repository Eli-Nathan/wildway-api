...
exports.setWeatherEnabled = exports.getUsageStats = exports.trackApiCall = exports.isWeatherAvailable = void 0;
 ...
 */
async function getUsageRecord(strapi) {
 ...
 */
async function getUsageStats(strapi) {
    const usage = await getUsageRecord(strapi);
    return {
        month: usage.month,
 ...
 */
async function setWeatherEnabled(strapi, enabled, reason) {
    const month = getCurrentMonth();
    await strapi.db.query("api::weather-usage.weather-usage").update({
        where: { month },
        data: {
...
exports.setWeatherEnabled = setWeatherEnabled;
