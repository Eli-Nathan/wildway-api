...
const sanitizeApiResponse_1 = __importDefault(require("../../../wildway/sanitizeApiResponse"));
/**
 ...
 */
async function recordMapImpressions(strapi, siteIds) {
...
exports.default = strapi_1.factories.createCoreController("api::site.site", ({ strapi }) => ({
    ...
    async getAnalytics(ctx) {
        ...
        const getMapImpressions = async (siteId) => {
            const knex = strapi.db.connection;
            const isPostgres = knex.client.config.client === "postgres";
            ...
            const previousResult = await knex("map_impressions")
                ...
                .sum("count as total")
                .first();
            const currentTotal = parseInt((currentResult === null || currentResult === void 0 ? void 0 : currentResult.total) || "0", 10);
            const previousTotal = parseInt((previousResult === null || previousResult === void 0 ? void 0 : previousResult.total) || "0", 10);
