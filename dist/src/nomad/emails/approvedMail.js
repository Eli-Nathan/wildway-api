...
const getMainBody = (type, title, slug, points) => `
...
`;
const getPlainText = (type, title, slug, points) => `
Good news!
...
wildway
`;
const getApprovedMailContent = (collection, title, slug, points) => {
...
exports.default = getApprovedMailContent;
