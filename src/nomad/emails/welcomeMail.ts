...
const getMainBody = (displayName: string): string => `
...
const getPlainText = (displayName: string): string => `
Welcome to the wildway community!
...
const getWelcomeMailContent = (displayName: string = ""): EmailContent => {
...
export default getWelcomeMailContent;
