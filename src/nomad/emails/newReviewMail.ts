...
const getMainBody = (data: ReviewData): string => `
...
const getPlainText = (data: ReviewData): string => `
New review for ${data.siteTitle}!
...
const getNewReviewMailContent = (data: ReviewData): EmailContent => {
...
export default getNewReviewMailContent;
