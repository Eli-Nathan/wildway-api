...
const getMainBody = (type: string, title: string): string => `
...
const getPlainText = (type: string, title: string): string => `
Uh oh!
...
const getRejectedMailContent = (collection: string, title: string): EmailContent => {
...
export default getRejectedMailContent;
